      ...
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl shadow-navy/5 overflow-hidden border border-slate-100 my-auto">
        ...
        <div className="bg-navy p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="w-20 h-20 bg-teal/20 rounded-2xl flex items-center justify-center mb-6 text-teal border border-teal/30 shadow-xl backdrop-blur-sm">
              <UserCircle className="h-10 w-10" />
            </div>
            <h1 className="text-4xl font-black font-heading mb-3">Complete Your Profile</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <textarea
                ...
                id="bio"
                rows={4}
                className="block w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-navy placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal/20 focus:border-teal focus:bg-white transition-all font-medium leading-relaxed resize-none"
            ...
            <div>
              ...
              <div className="mt-1 flex justify-center px-8 pt-8 pb-10 border-2 border-slate-100 border-dashed rounded-3xl hover:bg-teal/5 hover:border-teal transition-all cursor-pointer group relative">
                <input
                  type="file"
                  name="file"
                  id="fileUpload"
                ...
                <div className="space-y-4 text-center">
                  <div className="w-16 h-16 bg-slate-50 text-slate-400 rounded-2xl flex items-center justify-center mx-auto group-hover:bg-teal group-hover:text-white transition-all shadow-sm">
                    <UploadCloud className="h-8 w-8" />
                  </div>
                  <div className="flex text-sm text-slate-600 justify-center">
                    <span className="font-semibold text-teal uppercase tracking-widest text-xs">Upload a file</span>
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center gap-3 py-4 px-6 border border-transparent rounded-2xl shadow-xl shadow-teal/20 text-sm font-semibold text-white bg-teal hover:bg-navy focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal transition-all cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed uppercase tracking-widest"
              >
