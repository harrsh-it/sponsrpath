...
import { editJobAction } from "@/actions/jobs"
import { SalarySlider } from "@/components/ui/SalarySlider"
import { VisaBadge, SponsorStatus } from "@/components/ui/VisaBadge"
import { ArrowLeft, Briefcase, Banknote, ShieldAlert, CheckCircle, XCircle } from "lucide-react"
    ...
    <div className="max-w-3xl w-full mx-auto">
      <div className="mb-8 flex justify-between items-start">
        <div>
          ...
          <h1 className="text-3xl font-heading font-bold text-navy">Edit Job Listing</h1>
          <p className="text-slate-500 mt-1">
            Updating: <span className="font-semibold text-slate-800">{job.title}</span>
          </p>
        </div>
